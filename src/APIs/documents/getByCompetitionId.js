...
const {getDocumentbyIdCompetition} = require('../../Routes/documentsRoutes.js');


//Get de competiciones por id//
router.get(getDocumentbyIdCompetition, async (req, res) => {
    ...
    try {
        ...
        //Consulta SQL
        const [filas] = await conexion.execute("SELECT * FROM documents where competitionId=?",[idCompetition]);
